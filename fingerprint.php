...
<!-- <table width="1012" border="0" align="center" cellpadding="0" cellspacing="0" >
  <tr bgcolor="#848487">
	...
	<input type="textbox" id="tmplval" value="">
...
<script src="jquery.min.js"></script>
 ...
 <script>
		...
		function MatchFP() {
			...
			$.ajax({
            url: './phpmodules/fingerprintentry.php',
            method: 'POST',
            data: data,
            success: function (response) {
							...
							// for(i=9; i<=res[9].patient_id; ){
							// 	// console.log(res[i].fingerprint)

								crossDomainAjax("http://localhost:8090/FM220/GetMatchResult?MatchTmpl="+encodeURIComponent(res[11].fingerprint)+"&callback=?",
								function (result) {
								SuccessMatch(result);
								});
        ...
        function SuccessMatch(result) {
            if (result.errorCode == 0) {
                ...
                */
				...
				document.getElementById('result').innerHTML ="";
                alert("Fingerprint Capture ErrorCode " + result.errorCode + "Desc :-"+result.status+result.matchScore.toString());
            }
        }
